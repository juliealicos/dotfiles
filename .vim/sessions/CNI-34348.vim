...
let s:cpo_save=&cpo
set cpo&vim
inoremap <silent> <expr> <BS> coc#_insert_key('request', 'c013bb8b-8de4-11ea-9407-7dc686a3492d')
...
imap  <Plug>TComment_
inoremap <silent> <expr> " coc#_insert_key('request', 'c013bb89-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> ' coc#_insert_key('request', 'c013bb88-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> ( coc#_insert_key('request', 'c013bb80-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> ) coc#_insert_key('request', 'c013bb81-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> < coc#_insert_key('request', 'c013bb86-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> > coc#_insert_key('request', 'c013bb87-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> [ coc#_insert_key('request', 'c013bb82-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> ] coc#_insert_key('request', 'c013bb83-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> ` coc#_insert_key('request', 'c013bb8a-8de4-11ea-9407-7dc686a3492d')
cmap w!! w !sudo tee >/dev/null %
inoremap <silent> <expr> { coc#_insert_key('request', 'c013bb84-8de4-11ea-9407-7dc686a3492d')
inoremap <silent> <expr> } coc#_insert_key('request', 'c013bb85-8de4-11ea-9407-7dc686a3492d')
...
set matchpairs=(:),{:},[:],<:>,
set operatorfunc=<SNR>36_FormatFromSelected
set path=.,/usr/include,,,**
set runtimepath=~/.vim,~/.vim/plugged/dracula,~/.vim/plugged/vim-airline,~/.vim/plugged/tcomment_vim,~/.vim/plugged/vim-polyglot,~/.vim/plugged/coc.nvim,~/.vim/plugged/fzf,~/.vim/plugged/fzf.vim,~/.vim/plugged/vim-surround,~/.vim/plugged/goyo.vim,~/.vim/plugged/nerdtree,~/.vim/plugged/vim-devicons,~/.vim/plugged/matchit,~/.vim/plugged/emmet-vim,~/.vim/plugged/vim-vue-plugin,~/.vim/plugged/plantuml-syntax,~/.vim/plugged/vim-languagetool,~/.vim/plugged/vim-css-color,~/.vim/plugged/markdown-preview.nvim,~/.vim/plugged/vim-fugitive,~/.vim/plugged/vim-gitgutter,~/.vim/plugged/gitv,~/.vim/plugged/loremipsum,/usr/local/share/vim/vimfiles,/usr/local/share/vim/vim82,/usr/local/share/vim/vimfiles/after,~/.vim/plugged/dracula/after,~/.vim/plugged/vim-polyglot/after,~/.vim/plugged/vim-css-color/after,~/.vim/after,~/.config/coc/extensions/node_modules/coc-snippets
set shiftround
set shiftwidth=2
...
argglobal
%argdel
edit ~/WORK/OAM_ENV/trunk/C_Test/SC_OAM/SWM_SoftwareManagement/MT/test_cases/FSMr3/FCM_MasterTests.cpp
...
silent! normal! zE
let s:l = 822 - ((38 * winheight(0) + 19) / 39)
...
normal! 050|
tabnext 1
badd +3108 LinuxX86-64_WN_FCT/FCM_Master.cpp
badd +542 static/TargetBD.cpp
badd +155 include/SWM_SoftwareManagement/TargetBD.h
badd +650 ~/WORK/OAM_ENV/trunk/C_Test/SC_OAM/SWM_SoftwareManagement/MT/test_files/common/TargetBD_WithNeReleaseMode.xml
badd +150 include/SWM_SoftwareManagement/BuildElementRecord.h
badd +22 include/SWM_SoftwareManagement/XMLAttributeRecord.h
badd +76 static/BuildElementRecord.cpp
badd +15 static/XMLAttributeRecord.cpp
badd +32076 ~/WORK/OAM_ENV/trunk/C_Application/SC_OAM/SWM_SoftwareManagement/SWM_SoftwareManagement_rpy/FSMr3/FCM_Master.cls
badd +2301 ~/WORK/OAM_ENV/trunk/C_Test/SC_OAM/SWM_SoftwareManagement/MT/test_cases/FSMr3/FCM_MasterTests.cpp
badd +11 ~/WORK/OAM_ENV/trunk/C_Test/SC_OAM/SWM_SoftwareManagement/MT/helpers/common/TestFile.hpp
badd +12 ~/WORK/OAM_ENV/trunk/C_Test/SC_OAM/SWM_SoftwareManagement/MT/helpers/common/TestFile.cpp
badd +1 ~/WORK/OAM_ENV/trunk/C_Test/SC_OAM/SWM_SoftwareManagement/MT/test_files/common/TargetBD_WNxxxx1.xml
badd +600 ~/WORK/OAM_ENV/trunk/C_Test/SC_OAM/SWM_SoftwareManagement/MT/test_files/common/TargetBD_WithSwUpdateMetaFile.xml
badd +213 static/Master/SWUpdateMetaRules.cpp
badd +23 static/Master/SWUpdateMetaFileHandler.cpp
badd +18 include/SWM_SoftwareManagement/Master/SWUpdateMetaFileHandler.hpp
